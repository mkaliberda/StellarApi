...
Архитектура сервиса представляет собой дебитно/кредитную систему хнанения балансов.
Кредитые балансы отражают денежные обязательства перед клиентами (балансы которыми владеют пользователь), а дебитные - обязательства внешних сервисов, собственных активов владельцев системы.
...
При запуски сервиса **RS** имеет необходимое оборотное количество дубетных и кредетных активов. 
